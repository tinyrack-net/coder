...
`v4/secrets.json`. On POSIX systems the configuration directory is mode
...
credential formats. An incompatible `v4/secrets.json` produces an
...
needed. Normal startup and reset do not read, rewrite, or delete v2 or v3 data.

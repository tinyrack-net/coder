...
- `wait_agent` blocks until new agent activity or user input, and returns the messages it woke for in `messages`; call it sparingly and prefer doing useful work first.

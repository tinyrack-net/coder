...
/// Selects Tinest's semantic control density from the available window width.
///
...
class TinestControlDensity extends StatelessWidget {
  /// Creates the responsive density boundary around [child].
  const TinestControlDensity({required this.child, super.key});
